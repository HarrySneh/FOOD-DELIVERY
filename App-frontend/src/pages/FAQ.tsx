...
const faqs: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "Delivery typically takes 30-45 minutes depending on your location and restaurant preparation time. You can track your order in real-time.",
  },
  {
    id: 3,
    question: "What payment methods do you accept?",
    answer:
      "We accept card payments (Visa/Mastercard) and mobile money (MTN MoMo, Vodafone Cash, AirtelTigo Cash). All payments are processed securely.",
  },
  {
    id: 4,
    question: "How can I track my order?",
    answer:
      'Once your order is confirmed, you can track it from the "My Orders" section. When a driver is assigned, you will see their live location.',
  },
  {
    id: 5,
  ...
  },
  {
    ...
    answer:
      'Click on "Become a Driver" in your account menu after logging in. Fill out the registration form with your vehicle details.',
  },
  {
    id: 8,
    ...
    <div className={styles.container}>
      ...
      <div className={styles.faqGrid}>
        ...
        <div className={styles.contactCard}>
          ...
          <a href="mailto:support@tamaeat.com" className={styles.emailButton}>
            Email Support
          </a>
